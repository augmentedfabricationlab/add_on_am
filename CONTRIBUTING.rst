...
1. Fork `the repository <https://github.com/augmentedfabricationlab/add_on_am>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/add_on_am/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/add_on_am/issues>`_. If you are proposing a feature:
